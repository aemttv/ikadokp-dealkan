<x-layout title="Disewa Property">
    <?php
    $hadapType = [
        1 => 'Barat',
        2 => 'Selatan',
        ...
        <div class="relative flex flex-col justify-center items-center h-full px-4">
            ...
            <div class="container mx-auto mt-4 px-4">
                <div class="flex flex-col md:flex-row md:justify-center space-y-4 md:space-y-0 md:space-x-4">
                    <form action="{{ route('property.sewaSearch') }}" method="GET"
                        ...
                        <input type="hidden" name="source" value="disewa">
                        <button
                            class="px-6 py-3 mx-2 bg-gradient-to-r from-orange-400 to-orange-600 text-white rounded-md shadow-lg hover:to-orange-500 ">Cari</button>
                    </form>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="property-type-group" class="grid grid-cols-5 gap-2 mt-2 md:gap-3">
                            <label
                                ...
                                <input type="radio" name="Tipe" value="9" class="hidden">
                                Rumah
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="2" class="hidden">
                                Apart
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="1" class="hidden"> Office
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="Villa" class="hidden"> Villa
                            </label>
                            ...
                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="4" class="hidden"> Gudang
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="7" class="hidden"> Soho
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="8" class="hidden"> Ruko
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="5" class="hidden"> Hotel
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="3" class="hidden"> Gedung
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="10" class="hidden"> Tanah
                            </label>

                            <label
                                class="property-type-label bg-white text-gray-700 border border-gray-300 py-2 px-4 rounded-lg text-sm font-medium flex justify-center items-center cursor-pointer">
                                <input type="radio" name="Tipe" value="11" class="hidden"> Toko
                            </label>
                        </div>
                    </div>
        ...
        @if (!$sewa == [])
            <div class="flex justify-center md:justify-start mx-4 md:mx-32">
                <p class="text-gray-600 mt-2 text-center md:text-left">
                    Menampilkan {{ $sewa->firstItem() }}-{{ $sewa->lastItem() }} dari total
                    {{ $sewa->total() }} properti
                </p>
            </div>
        @endif
    ...
    @if ($sewa)
        <div class="flex justify-center items-center my-10 overflow-x-auto max-w-full">
            {{ $sewa->links('pagination::tailwind') }}
        </div>
    @endif
